            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">{{__('Create Page')}}</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">{{__('Create Page')}}
                                    </li>
                                </ol>
                            </div>
                        </div>
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane show active" id="pTitleAr">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="{{__('Title Ar')}}" name="title_ar" required="" value="">

                                                    </div>
                                                    <label class="col-form-label">{{__('Description Ar')}} <span style="color: red"> * </span></label>
                                                    <textarea required=""  id="description_ar" class="summernote" rows="10" placeholder="{{__('Description Ar')}}" name="description_ar"></textarea>
                                                </div>
                                                @if(in_array('en',$language))
                                                <div class="tab-pane" id="pTitleEn">
                                                    <div class="form-group">
                                                        <label class="col-form-label">{{__('Title En')}}  <span style="color: red"> * </span></label>
                                                        <input type="text" class="form-control" placeholder="{{__('Title En')}} " name="title_en" required="" value="">

                                                    </div>
                                                    <label class="col-form-label">{{__('Description En')}} <span style="color: red"> * </span></label>
                                                    <textarea required=""  id="description_en" class="summernote" rows="10" placeholder="{{__('Description En')}}" name="description_en"></textarea>
                                                </div>
                                                @endif
                                            </div>
                                            <div class= mt-2">
