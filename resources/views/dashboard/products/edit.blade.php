            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">{{__('Edit Product')}}</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{route('dashboard')}}">{{__('Home')}}</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="{{route('product.index')}}">{{__('Product')}}</a>
                                    </li>
...
{{--                                        <input name="product_images" value="[]" type="hidden"/>--}}
                                        ...
                                        <input name="cover_image" value="{{$product->cover_image}}" type="hidden"/>
                                        <div class="form-row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="tab-content">
                                                    <div role="tabpanel" class="tab-pane active" id="ar" aria-labelledby="ar-tab" aria-expanded="true">
                                                        <label class="form-label" for="basic-default-name">{{__('Name Arabic')}}
                                                            <span style="color: red">*</span>
                                                        </label>
                                                        <input type="text" class="form-control" id="name_ar" name="name_ar" value="{{$product->name_ar}}" placeholder="{{__('Name Arabic')}}" />
                                                    </div>
                                                    @if(in_array('en',$language))
                                                        <div class="tab-pane" id="en" role="tabpanel" aria-labelledby="en-tab" aria-expanded="false">
                                                            <label class="form-label" for="basic-default-name">{{__('Name English')}}
                                                                <span style="color: red">*</span>
                                                            </label>
                                                            <input type="text" class="form-control" id="name" name="name" value="{{$product->name}}" placeholder="{{__('Name English')}}" />
                                                        </div>
                                                    @endif
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="custom-control custom-switch custom-switch-large text-right">
                                                            <input name="status" checked="" type="checkbox" value="{{$product->status}}" {{$product->status == 1 ?'checked':''}} class="custom-control-input" id="customSwitch4">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="input-group ">
                                                            ...
                                                            <input type="text" class="form-control" name="price" id="price" value="{{$product->price}}" placeholder="{{__('Price')}}" aria-label="Username" aria-describedby="basic-addon1">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" value="{{$product->cost_price}}" id="cost_price" name="cost_price" placeholder="{{__('This field does not appear for the customer')}}" />
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" value="{{$product->code}}" id="code" name="code" placeholder="{{__('Product Code')}}" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" value="{{$product->quantity}}" id="quantity" name="quantity" placeholder="{{__('Quantity')}}" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" value="{{$product->weight}}" id="weight" name="weight" placeholder="{{__('Weight')}}" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <div class="custom-control custom-checkbox">
                                                                <input type="checkbox" class="custom-control-input" {{$product->sale !=null ? 'checked' :''}} id="input-check">
                                                                <label class="custom-control-label" for="input-check">{{__('Sale')}}</label>
                                                                <div class="input-check">
                                                                    @if($product->sale !=null)
                                                                    <input type="text" value="{{$product->sale}}" class="form-control" name="sale" id="sale" placeholder="{{__('Sale')}}" >
                                                                    @endif
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        @foreach($categories as $category)
                                                            <optgroup label="{{App::isLocale('en')?$category->name??$category->name_ar:$category->name_ar??$category->name}}">
                                                                @foreach($category->child as $child)
                                                                    <option value="{{ $child->id}}" {{ in_array($child->id, $product_cat)? "selected" : "" }}>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="tab-content">
                                                    <div role="tabpanel" class="tab-pane active" id="description_ar" aria-labelledby="description-ar-tab" aria-expanded="true">
                                                        ...
                                                        <textarea id="description_ar" class="summernote" rows="10" placeholder="{{__('Description')}}" name="description_ar">{{$product->description_ar}}</textarea>                                                    </div>
                                                    @if(in_array('en',$language))
                                                        <div class="tab-pane" id="description_en" role="tabpanel" aria-labelledby="description-en-tab" aria-expanded="false">
                                                            <label class="form-label" for="basic-default-name">
                                                                {{__('Description')}}
                                                            </label>
                                                            <textarea id="description_en" class="summernote" rows="10" placeholder="{{__('Description EN')}}" name="description_en">{{$product->description}}</textarea>                                                        </div>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="varients">
                                                ...
                                                @foreach($product->productOption as $option)
                                                    <div class="from-group col-md-12 specification">
                                                        <div class="product_specification" data-id="{{$option->id}}">
                                                            <div class="row spec-item titles mb-2">
                                                                <div class="col-md-5">
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="text" name="options[{{$option->id}}][content][title_ar]" value="{{$option->name_ar}}"
                                                                ...
                                                                <div class="col-md-5">
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="text" name="options[{{$option->id}}][content][title_en]" value="{{$option->name}}"
                                                                               class="form-control title"
                                                                ...
                                                                <div class="row spec-item title_values mb-2">
                                                                    <div class="col-md-3">
                                                                        <div class="input-group">
                                                                            ...
                                                                            <input type="text"
                                                                                   name="options[{{$option->id}}][content][content_details][{{$value->id}}][content_name_ar]" value="{{$value->name_ar}}"
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <div class="input-group">
                                                                            ...
                                                                            <input type="text"
                                                                                   name="options[{{$option->id}}][content][content_details][{{$value->id}}][content_name_en]" value="{{$value->name}}"
                                                                    ...
                                                                    <div class="col-md-4 col-6">
                                                                        <div class="input-group">
                                                                            ...
                                                                            <input type="number"
                                                                                   name="options[{{$option->id}}][content][content_details][{{$value->id}}][additional_price]" value="{{$value->additional_price}}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <form id="sample-img">
                                            <div class="dropzone" id="myEditDropzone">
                                                <div class="fallback">
                                                    <input name="file[]" id="cropperFileInput" accept="image/*" type="file"
                                                           multiple/></div>
                                                <div class="dz-message needsclick">
                                                    {{--                                                    <img src="https://mapp.sa/images/upload-icon.png" width="40px">--}}
                                            ...
                                            <div class="col-md-2 col-6">
                                                <div class="show_check_box mid" style="margin-right:0 !important;">
                                                    <div class="custom-control custom-switch text-right">
                                                        <input name="categories[{{$category->id}}][status]"   checked="" type="checkbox" class="switch custom-control-input" data-activate_desc=" {{__('Stop displaying the category in the main')}}  " data-id="{{$category->id}}" data-deactivate_desc=" {{__('')}} " data-activate_url="{{route('category.activate',$category->id)}}" data-deactivate_url="{{route('category.deactivate',$category->id)}}" id="customSwitch_show{{$category->id}}">
    ...
    <div class="modal fade" id="ProductmoreOptions" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">{{__('Edit Options')}}</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form id="add_cats" method="post" action="javascript:void(0)">
                    <div class="modal-body">
                        <div class="row" id="form_specifications">
                            <p style="color: #4f549f;text-align: center;max-width: 600px;
                        ...
                        <div class="form-group col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form_specifications_q">

                                        <div class="variant_row row mb-2">
                                            <div class="col-md-8">
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                    <span class="input-group-text" id="basic-addon1">
                                                        <i class=" mdi mdi-format-color-text"></i></span>
                                                    </div>
                                                    <input name="variants[0][name_ar]" type="hidden" value="fgh-fgh" class="form-control " aria-describedby="basic-addon1">
                                                    <input name="variants[0][name_en]" type="hidden" value="fgh-fgh" class="form-control " aria-describedby="basic-addon1">
                                                    <input name="variants[0][name_ar]" disabled="" type="text" value="fgh-fgh" class="form-control " aria-describedby="basic-addon1">
                                                    <input name="variants[0][name_en]" disabled="" type="text" value="fgh-fgh" class="form-control " aria-describedby="basic-addon1">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="input-group">
                                                    <div class="input-group-prepend"> <span class="input-group-text" id="basic-addon1">
                                                        <i class=" mdi mdi-cart-arrow-down"></i></span>
                                                    </div>
                                                    <input type="hidden" name="variants[0][quantity]" value="10">
                                                    <input type="number" name="variants[0][quantity]" value="10" data-class="variants_0_quantity" class="variants_input form-control variants_0_quantity" placeholder="الكمية" aria-describedby="basic-addon1">
                                                </div>
                                            </div>
                                            <div class="col-md-1">
                                                <a href="javascript:void(0)" id="0" class="deleteOption btn-danger deleteOption_0"><i class="mdi mdi-delete"></i></a>
                                            </div>
                                        </div>
        ...
        $('#input-check').on("change",function ()
        {
            if ($('#input-check').is(":checked")){
                $('.input-check').append('<div class="input-group ">'+
                    '<div class="input-group-prepend">'+
                    '<span class="input-group-text" id="basic-addon1">{{$market->country->currency_short}}</span>'+
                    '</div>'+
                    '<input type="text" value="{{$product->sale}}" class="form-control" name="sale" id="sale" placeholder="{{__('Sale')}}" >'+
                    '</div>')
            }else {
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                if (response.status == 1) {
                                    ...
                                    tradMarkSelect.append('<option value="">{{__('Choose the product brand')}}</option>');

                                    $.each(response.items.brands, function (i, option) {
                                        //console.log(option)
                                        tradMarkSelect.append('<option value="' + option['id'] + '">' + @if(App::isLocale('en') )option["name"]||option["name_ar"]@else option["name_ar"]||option["name"] @endif + '</option>');
                            ...
                            if (result) {
                                ...
                                $.ajax({
                                    ...
                                    error: function (data) {
                                        swal.fire({
                                            icon: 'error',
                                            title: '{{__('Sorry, there was an error during the  process')}}',
                                            timer: 4000,
                                            buttons: {
                                                confirm: {
                                                    text: "{{__('Confirm !')}}",
    ...
    <script>
       @foreach($product->productImages as $item)
        previewThumbailFromUrl({
            selector: 'myEditDropzone',
            fileName: '{{$item->image_url}}',
            imageURL: "{{asset('uploads/products')."/".$item->image_url}}",
            isMain: '{{$item->image_url == $product->cover_image ?"1":"0"}}',
        });
        @endforeach
        ...
        $(document).ready(function (e) {
            ...
            $('#save_data').click(function () {
                ...
                if ($('input[name="product_images"]').val() == '[]') {
                    $('#sample-img').parent().append('<div style="margin: 0px 0px 10px;" id="images-error" class="abs_error help-block has-error">{{__('You must upload at least one image of the product')}}</div>');

                    loader.fadeOut(200);
                    return false;
                }
                //$('#form_data').submit();
                var action_url = "{{ route('product.update',$product->id)}}";
                $.ajaxSetup({
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    }
