                 ...
                 <div class="modal-body flex-grow-1">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="password" id="password" name="password" class="form-control" value="" placeholder="{{__('New Password')}}">
                                        </div>
                                        <div class="form-group col-md-12">
                                            <input type="password" id="password_confirmation" name="password_confirmation" class="form-control" value="" placeholder="{{__('Verify Password')}}">
                                        </div>
                                    </div>
                                </div>
...
//                                         $name = full['name_ar'],
{{--                                        @endif--}}
                                        $initials = $name.match(/\b\w/g) || $name.match(/([\u0600-\u06ff])/g);
