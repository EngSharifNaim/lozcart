        ...
        <div class="kt-subheader   kt-grid__item" id="kt_subheader">
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__breadcrumbs">
                    ...
                    <span class="kt-subheader__breadcrumbs-separator"></span>
                    <a href="{{route('admin.center.category.create')}}" class="kt-subheader__breadcrumbs-link">
                        {{__('New Category')}}
                    </a>
                        ...
                        <form class="kt-form" id="mainAdd" method="post" action="javascript:void(0)" >
                            ...
                            <div class="kt-portlet__body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"  name="title"  placeholder="{{__('Enter')}} {{__('Title')}}">
                                </div>
                            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on("click", "#add_form", function() {
                ...
                $.ajax({
                    url: "{{ route('admin.center.category.store')}}",
                    type: "POST",
                    data: postData,
                    processData: false,
                    contentType: false,
