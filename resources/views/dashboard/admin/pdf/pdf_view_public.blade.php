...
<table class="table-fill">
    ...
    <tr>
        ...
        <td>{{$visit->medical_center->name}}</td>
        ...
        <tr>
            <td colspan="6" class="text-left">
                ...
                Consultation :<br> {{$visit->consultation->doctor_notes}}
                @endif</td>
        </tr>
    <tr>
        <td colspan="6" class="text-left">
            ...
            Prescription :<br> {{$visit->consultation->prescription->prescription_details}}            @endif</td>
