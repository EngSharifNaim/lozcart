                    ...
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            <div class="kt-portlet__head-actions">
                                <a href="{{route('admin.centers.create')}}" class="btn btn-brand btn-elevate btn-icon-sm">
                                    ...
                                    <table class="table  table-bordered table-hover  " id="table_1">
                                        ...
                                        @foreach($users as $user)
                                            <tr id="user_row_{{$user->id}}">
                                                ...
                                                <td>
                                                        <a class="btn btn-primary" href="{{ route('admin.centers.edit',[$status,$user->id])}}">
                                                            <i class="flaticon-settings-1"></i>
                                                        </a>
                                                        <a class="btn btn-warning" href="{{ route('admin.centers.users',[$status,$user->id])}}">
                                                            {{__('Users')}}
                                                        </a>
                                                        <a class="btn btn-secondary" href="{{ route('admin.centers.profile',[$status,$user->id])}}">
                                                            {{__('Profile')}}
                                                        </a>
...
{{--    <script type="text/javascript" charset="utf8" src="https://cdn.datatables.net/1.10.22/js/jquery.dataTables.js"></script>--}}
    ...
    <script type="text/javascript">
        ...
        function changeStatus(id) {
            ...
            $.ajax({
                url: "{{ url("admin/status_centers/")}}" + '/' + id,
                type: "POST",
                data: {
                    status: status_new,
                    _token: token,
        ...
        function deleteConfirmation(id) {
            ...
            swal.fire({
                ...
                if (e.value === true) {
                    ...
                    $.ajax({
                        type: 'delete',
                        url: "{{ url("admin/delete_centers/")}}/" + id,
