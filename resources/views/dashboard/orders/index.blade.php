...
{{--    <script src="../../../app-assets/custom/staff.js"></script>--}}
    ...
    <script>
        $(function () {
            ...
            statusObj = {
                0: { title: '0',text:'{{__("New")}}', class: 'badge-light-info' },
                1: { title: '1',text:'{{__("Processing")}}', class: 'badge-light-primary' },
                2: { title: '2',text:'{{__("Ready to ship")}}', class: 'badge-light-secondary' },
                3: { title: '3',text:'{{__("Delivering")}}', class: 'badge-light-warning' },
                4: { title: '4',text:'{{__("Delivered")}}', class: 'badge-light-success' },
                5: { title: '5',text:'{{__("Rejected")}}', class: 'badge-light-danger' },
            };
                    ...
                    columnDefs: [
                        ...
                        },
                        {
                            ...
                            render: function (data, type, full, meta) {
                                ...
                                var $row_output =
                                    '<a href="{{route('user.edit','').'/'}}'+full['user_id']+'" target="_blank">'+
                        ...
                        },
                        {
                            ...
                            render: function (data, type, full, meta) {
                                ...
                                return (
                                    '<span  " text-capitalized>' +
                                        @if(App::isLocale('en'))
                                            full['total_price']+ $currency.currency_short
                                        @else
                                            full['total_price']+ $currency.currency_short_ar
                                        @endif
                                        +
                                    '</span>'
                                );
